...
$docs = array(
	...
	'PHPIDS-license' => array( 'legend' => 'PHPIDS License', 'file' => WEB_PAGE_TO_PHPIDS . 'LICENSE' ),
);
...
$instructions = file_get_contents( ROOT.$readFile );

function urlReplace( $matches ) {
	return ExternalLinkUrlGet( $matches[1] );
}
